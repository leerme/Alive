...
@interface GPRevealMenuViewController ()

@end

@implementation GPRevealMenuViewController

#pragma mark Memory Management
- (id)initWithSidebarViewController:(GHRevealViewController *)sidebarVC withSearchBar:(UISearchBar *)searchBar withHeaders:(NSArray *)headers withControllers:(NSArray *)controllers withCellInfos:(NSArray *)cellInfos
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GPRevealMenuCell *cell = (GPRevealMenuCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[GPRevealMenuCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
